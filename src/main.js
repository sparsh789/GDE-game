...
const renderStartScreen = lastText => {
  renderTexts(
    "THE RETURN of JAADU                       ",
    "",
    "JAADU tired by the abuse of his powers by Rohit           ",
    "Mehra, decides to go to Area 51 and find the spaceship    ",
    "to reach back home.                                       ",
    "",
    "Controls                                                   ",
